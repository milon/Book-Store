...
<%!
	String RecordAction(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sAction, String sForm, Connection conn, Statement stat) throws IOException {
		String sRecordErr ="";
	...
	void Record_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sRecordErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {
		try{
			String sSQL="";
			String sQueryString = "";
			String sPage = "";
