...
<%!
	String BookAction(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sAction, String sForm, Connection conn, Statement stat) throws IOException {
		String sBookErr ="";
	...
	void Book_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sBookErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {
		try{
			String sSQL="";
			String sQueryString = "";
			String sPage = "";
