	...
	void Orders_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sOrdersErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {  
		...
		try {			
			...
			while((iCounter < RecordsPerPage) && rs.next()){
				...
				out.println("<tr>");      
				out.print("<td style=\"background-color: #FFFFFF; border-width: 1\">"); 
				out.print("<a href=\"OrdersRecord.jsp?"+transitParams+"order_id="+toURL((String) rsHash.get("o_order_id"))+"&\"><font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldField1)+"</font></a>");
				out.println("</td>");
				...
				out.print("<td style=\"background-color: #FFFFFF; border-width: 1\">"); 
				out.print("<font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldmember_id)+"&nbsp;</font>");
				out.println("</td>");
