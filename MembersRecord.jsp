...
<%!
	String MembersAction(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sAction, String sForm, Connection conn, Statement stat) throws IOException {  
		String sMembersErr ="";
	...
	void Members_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sMembersErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {
		try{
			String sSQL="";
			String sQueryString = "";
			String sPage = "";
