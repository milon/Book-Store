...
<%!
	void Items_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sItemsErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {  
		String sWhere = "";
		int iCounter=0;
		int iPage = 0;
		...
		try{
			...
			while(rs.next()){
				...
				out.print("<a href=\"ShoppingCartRecord.jsp?"+transitParams+"order_id="+toURL((String) rsHash.get("order_id"))+"&\"><font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldField1)+"</font></a>");
				out.println("</td>");
				
				out.print("<td style=\"background-color: #FFFFFF; border-width: 1\">"); 
				out.print("<font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldorder_id)+"&nbsp;</font>");
				out.println("</td>");
				...
				out.print("<td style=\"background-color: #FFFFFF; border-width: 1\">"); 
				out.print("<font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldsub_total)+"&nbsp;</font>");
				out.println("</td>");
				out.println("</tr>");
	...
	void Total_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sTotalErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {  
		String sWhere = "";
		int iCounter=0;
		int iPage = 0;
		boolean bIsScroll = true;
	...
	String MemberAction(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sAction, String sForm, Connection conn, Statement stat) throws IOException {  
		String sMemberErr ="";
	...
	void Member_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sMemberErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException {
		try{
			String sSQL="";
			String sQueryString = "";
			String sPage = "";
