...
<%!
	void Results_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sResultsErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException{
		String sWhere = "";
		int iCounter=0;
		int iPage = 0;
	...
	void Search_Show(HttpServletRequest request, HttpServletResponse response, HttpSession session, JspWriter out, String sSearchErr, String sForm, String sAction, Connection conn, Statement stat) throws IOException{
		try{
			...
			out.print("<td style=\"background-color: #FFFFFF; border-width: 1\">"); 
			out.print("<input type=\"text\"  name=\"name\" maxlength=\"10\" value=\""+toHTML(fldname)+"\" size=\"10\">");
			out.println("</td>\n </tr>\n <tr>");
